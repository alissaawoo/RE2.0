...
/*    self.sell_ticket_event = function(_idx) {
        $.post(sell_ticket_event_url,
            {
                title: self.vue.events[_idx].event.displayName,
                price: self.vue.form_price,
                date: self.vue.form_date,
                description: self.vue.form_description,
                genre: self.vue.form_genre,
                location: self.vue.events[_idx].event.location.city,
